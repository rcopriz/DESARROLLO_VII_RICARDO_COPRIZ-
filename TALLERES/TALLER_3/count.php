...
$misCanciones = ['le llaman guerrero','yo tengo gozo en mi alma','al que esta sentado en el trono']; // Reemplaza esto con tu array de canciones
...
$playlist = [
    "worship" => ["jeshua", "hermoso momento"],
    "coritos" => ["cuando alla se pase lista", "", "Beat It"],
    "clasicos" => ["al borde de su manto", "como la brisa"]
];
