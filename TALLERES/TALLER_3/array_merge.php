...
$misComidas = ["arroz con pollo", "arroz frito", "pizza"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["pizza", "arroz con mariscos", "langosta"]; // Reemplaza con las comidas favoritas de tu amigo
