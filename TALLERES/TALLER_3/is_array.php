...
$miArray = ["elemeno 1","elemento 2"]; // Reemplaza esto con tu propio array
$miString = "elemento 1, elemento 2"; // Reemplaza esto con tu propio string
$miNumero = 555; // Reemplaza esto con tu propio número
