...
echo "<br><br>Frase original: $frase</br>";
...
$misPeliculas = "la era del hielo-yo antes de ti-jurasic park-spiderman"; // Reemplaza esto con tu lista de películas
